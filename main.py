...
if __name__ == "__main__":
    ...
    for random_seed in [100]:  # for random_seed in [100, 330, 42]:
        for generations in [50]:  # for generations in [1000,2000]:
            for evaluation_method in [0]:  # 0-fitness, 1- novelty, 2-fitness and novelty
                for repertoire_index in [1, 2, 3, 4, 5, 6, 7]:  # for repertoireIndex in [0..7]:
                    for dissim_thresh in [0.45, 0.55]:
