...
GAIT_STYLE = [["MaxStepX", 0.06],  # maximum forward translation along X (meters)	0.040	0.001	0.080
              ["MaxStepY", 0.14],  # absolute maximum lateral translation along Y (meters)	0.140	0.101	0.160
              ...
              ["StepHeight", 0.010],  # peak foot elevation along Z (meters)	0.020	0.005	0.040
